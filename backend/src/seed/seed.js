...
async function seed() {
  try {
    ...
    // Do NOT use { alter: true } with TiDB here.
    // It can generate ALTER TABLE statements that conflict
    // with existing UNIQUE constraints.
    ...
    const email =
      process.env.ADMIN_EMAIL || "admin@vishalmall.dev";
    ...
    if (!existing) {
      ...
      console.log(
        `• Admin ${email} already exists — skipping.`
      );
    }
    ...
    await Settings.findOrCreate({
      ...
      defaults: {
        ...
        phone: "+91 8419073041",
        address:
          "Medanipur, Ghughali, Maharajganj, Uttar Pradesh, 273151, India",

        socialLinks: {
          linkedin:
            "https://www.linkedin.com/in/vishal-mall-536506302/",
          github:
            "https://github.com/vishalmall8419",
        },
      },
    });
    ...
    const educationRows = [
      {
        institute: "Sachidanand Inter College",
        degree: "Class 10",
        order: 0,
      },
      {
      ...
      {
        institute:
          "Shrinath Ji Institute for Technical Education",
        degree: "B.Tech",
        order: 3,
      },
    ];
